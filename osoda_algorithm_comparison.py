...
def main(settings, extraAlgosToTest=[]):
    ...
    final_scores_allcombos_AiS_AT={}; 
    final_scores_allcombos_AiS_DIC={};
    
    final_scores_allcombos_PiS_AT={};
    final_scores_allcombos_PiS_DIC={};
    
    final_scores_allcombos_OFS_AT={};
    final_scores_allcombos_OFS_DIC={};
    
    final_scores_allcombos_RiS_1_AT={};
    final_scores_allcombos_RiS_1_DIC={};
    
    final_scores_allcombos_RiS_2_AT={};
    final_scores_allcombos_RiS_2_DIC={};
    
    final_scores_allcombos_CA_AT={};
    final_scores_allcombos_CA_DIC={};
    ...
    import pickle
    with open("output/algo_metrics/AiS_AT_finalscores_pickled.txt", "wb") as myFile:
        pickle.dump(final_scores_allcombos_AiS_AT, myFile)
    
    with open("output/algo_metrics/AiS_DIC_finalscores_pickled.txt", "wb") as myFile2:
        pickle.dump(final_scores_allcombos_AiS_DIC, myFile2) 
        
    with open("output/algo_metrics/PiS_AT_finalscores_pickled.txt", "wb") as myFile3:
        pickle.dump(final_scores_allcombos_PiS_AT, myFile3) 
        
    with open("output/algo_metrics/PiS_DIC_finalscores_pickled.txt", "wb") as myFile4:
        pickle.dump(final_scores_allcombos_PiS_DIC, myFile4)
        
    with open("output/algo_metrics/RiS_1_AT_finalscores_pickled.txt", "wb") as myFile5:
         pickle.dump(final_scores_allcombos_RiS_1_AT, myFile5) 
        
    with open("output/algo_metrics/RiS_1_DIC_finalscores_pickled.txt", "wb") as myFile6:
         pickle.dump(final_scores_allcombos_RiS_1_DIC, myFile6)
        
    with open("output/algo_metrics/RiS_2_AT_finalscores_pickled.txt", "wb") as myFile7:
        pickle.dump(final_scores_allcombos_RiS_2_AT, myFile7) 
        
    with open("output/algo_metrics/RiS_2_DIC_finalscores_pickled.txt", "wb") as myFile8:
         pickle.dump(final_scores_allcombos_RiS_2_DIC, myFile8)
        
    with open("output/algo_metrics/CA_AT_finalscores_pickled.txt", "wb") as myFile9:
         pickle.dump(final_scores_allcombos_CA_AT, myFile9) 
        
    with open("output/algo_metrics/CA_DIC_finalscores_pickled.txt", "wb") as myFile10:
         pickle.dump(final_scores_allcombos_CA_DIC, myFile10)
        
    with open("output/algo_metrics/OFS_AT_finalscores_pickled.txt", "wb") as myFile11:
        pickle.dump(final_scores_allcombos_OFS_AT, myFile11) 
        
    with open("output/algo_metrics/OFS_DIC_finalscores_pickled.txt", "wb") as myFile12:
        pickle.dump(final_scores_allcombos_OFS_DIC, myFile12)
    #Shutdown logger
